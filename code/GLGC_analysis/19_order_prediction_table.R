load("/Users/zhangh24/GoogleDrive/multi_ethnic/result/GLGC/analysis_result/prediction.result.summary.rdata")
order.trait =  c("HDL",
                 "LDL",
                 "logTG",
                 "TC")
...
write.csv(order.result, file = "/Users/zhangh24/GoogleDrive/multi_ethnic/result/GLGC/analysis_result/prediction_summary.csv")
