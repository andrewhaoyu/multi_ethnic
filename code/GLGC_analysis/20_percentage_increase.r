...
write.csv(ratio_result_summary, file = "/Users/zhangh24/Library/CloudStorage/Box-Box/multi_ethnic/result/GLGC/analysis_result/ct_sleb_prscsx_ratio_summary.csv",
            row.names = F)
