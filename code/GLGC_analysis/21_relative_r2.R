...
all_trait_name =c("Heart metabolic disease burden",
                  ...
                  "Body mass index",
                  "Height (AoU)")
all_eth_name = c("European", "African", "Latino", "East Asian", "South Asian")
eth_vec = rep(0,100)
trait_vec = rep(0,100)
r2_ratio = rep(0,100)
...
ratio_result = data.frame(eth_vec, trait_vec, method_vec, r2_ratio)
write.csv(ratio_result, file = "/Users/zhangh24/GoogleDrive/multi_ethnic/result/GLGC/analysis_result/relative_r2.csv")
