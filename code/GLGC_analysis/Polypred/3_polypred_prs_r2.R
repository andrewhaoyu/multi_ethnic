...
file_dir = paste0("/data/zhangh24/multi_ethnic/result/GLGC/prs/polypred/",eth[1],"/",trait[l])
#coefs are based on EUR population
files = dir(file_dir, pattern = ".snpRes", full.names = T)
eur_coef = paste0("/data/zhangh24/multi_ethnic/result/GLGC/prs/polypred/",eth[1],"/",trait[l],"/SBayesR.snpRes")
...
#coefs are based on EUR population
files = dir(file_dir, pattern = ".snpRes", full.names = T)
tar_coef = paste0("/data/zhangh24/multi_ethnic/result/GLGC/prs/polypred/",eth[i],"/",trait[l],"/SBayesR.snpRes")
tar_con = 1
#load result
...
poly_fun_file_out = paste0("/data/zhangh24/multi_ethnic/result/GLGC/prs/polypred/",eth[1],"/",trait[l],"/poly_fun")
...
out.dir = paste0("/data/zhangh24/multi_ethnic/result/GLGC/polypred/",eth[i],"/",trait[l],"/")
