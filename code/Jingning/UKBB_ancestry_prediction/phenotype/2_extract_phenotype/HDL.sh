...
#cat /dcl01/arking/data/UK_Biobank/static/Phenotype/Downloads/tab_delim/ukb45830.tab | awk -F '\t' '{ print $1, $14456, $14457}' > /dcs04/nilanjan/data/jzhang2/UKBB/phenotype/${trait}/${trait}_from_ukbb.txt
