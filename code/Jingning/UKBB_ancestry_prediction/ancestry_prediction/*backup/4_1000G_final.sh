...
--bfile /dcs04/nilanjan/data/jzhang2/UKBB/ancestry_prediction/1000G_qc/chr2122 \
...
--make-bed \
--out /dcs04/nilanjan/data/jzhang2/UKBB/ancestry_prediction/1000G_final/chr2122
