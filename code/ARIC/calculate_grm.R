...
res <- system(paste0("/dcl01/chatterj/data/hzhang1/multi_ethnic_data_analysis/gcta/gcta64 --bfile ",data.dir,trait[1],"/",eth[i],"/geno/mega/chr.qc",j," --maf 0.05 --make-grm --out ",temp.dir,"chr.qc",j))
