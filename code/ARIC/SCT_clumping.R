...
#   for(l in c(1,3)){
    ...
    geno.dir = "/dcl02/leased/chatterj/hzhang1/multi_ethnic/result/ARIC/"
    ...
    snp_readBed(paste0(geno.dir,trait[1],"/",eth[i],"/all_chr.bed"))
    obj.bigSNP <- snp_attach(paste0(geno.dir,trait[1],"/",eth[i],"/geno/mega/chr.qc",j,".rds"))
