    ...
    for(w_ind in 1:length(wc_vec)){
      ...
      for(k1 in 1:length(pthres)){
        for(k2 in 1:length(pthres)){
          ...
          filename <- paste0(temp.dir,"/EBprs_rind_",r_ind,"_wcind_",w_ind,"p_value_",k1,"_",k2,".profile")
...
ARIC.result.EB = list(r2.result,result.data)
...
save(ARIC.result.EB,file = paste0("/dcl01/chatterj/data/hzhang1/multi_ethnic_data_analysis/multi_ethnic/result/ARIC/ARIC.result.EB.rdata"))    
#}
