...
k =12
  prs.all <- prs.clump %>% 
    ...
    length(idx)            
    r2.vec.test.prs[temp] = summary(model1.full)$r.square-summary(model1.prs)$r.square
    r2.vec.vad.prs[temp] = summary(model2.full)$r.square-summary(model2.prs)$r.square
