...
out_name =  paste0("/data/zhangh24/multi_ethnic/result/AOU/prs/polypred/",eth[i],"/",trait[l],"/SBayesR")
...
out_file = paste0("/data/zhangh24/multi_ethnic/result/AOU/prs/polypred/",eth[i],"/",trait[l],"/SBayesR.snpRes")
gamma_last = 1
