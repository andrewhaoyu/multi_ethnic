...
dir.create(paste0('/lscratch/',sid,'/test/1KGLD/ldblk_1kg_afr'),showWarnings = FALSE)
dir.create(paste0('/lscratch/',sid,'/test/1KGLD/ldblk_1kg_amr'),showWarnings = FALSE)
dir.create(paste0('/lscratch/',sid,'/test/1KGLD/ldblk_1kg_eas'),showWarnings = FALSE)
...
system(paste0("cp -r /data/zhangh24/software/PRScsx/1KGLD_MEGA/ldblk_1kg_afr/ldblk_1kg_chr",j,".hdf5 ",temp.dir,"1KGLD/ldblk_1kg_afr/."))
system(paste0("cp -r /data/zhangh24/software/PRScsx/1KGLD_MEGA/ldblk_1kg_amr/ldblk_1kg_chr",j,".hdf5 ",temp.dir,"1KGLD/ldblk_1kg_amr/."))
system(paste0("cp -r /data/zhangh24/software/PRScsx/1KGLD_MEGA/ldblk_1kg_eas/ldblk_1kg_chr",j,".hdf5 ",temp.dir,"1KGLD/ldblk_1kg_eas/."))
