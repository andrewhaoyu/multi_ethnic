...
library(data.table)
haplotype <- fread(paste0("/data/zhangh24/KG.impute2/1000GP_Phase3/1000GP_Phase3_chr",i2,".hap"),header=F)
...
fwrite(hap.sub,file =paste0("/data/zhangh24/KG.impute2/",country[i1],"/chr",i2,".hap"),
            row.names = F,
            col.names=F,
            quote=F,
            sep=" ")
