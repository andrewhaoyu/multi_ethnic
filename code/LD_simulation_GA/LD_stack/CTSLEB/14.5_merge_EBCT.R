    ...
    for(l in 1:3){
      for(m in 1:1){
        ...
        for(i_rep in 1:n.rep){
          ...
          filename =  paste0(out.dir,eth[i],"/r2.list_ebct_rho_eb_",l,"_size_",m,"_rep_",i_rep,"_GA_",i1)
          load(filename)
...
save(EB.result,file = paste0(out.dir,"EBCT.rdata"))
