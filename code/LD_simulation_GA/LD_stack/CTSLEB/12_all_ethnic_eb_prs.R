...
post_beta_mat = EBpostMulti(beta_tar,sd_tar,
                            ...
                            sd_other_mat,
                            prior.sigma)
post_beta_tar = post_beta_mat[,c(1:2),drop=F]
...
for(r_ind in 1:length(r2_vec)){
  ...
  for(w_ind in 1:length(wc_vec)){
    ...
    for(k1 in 1:length(pthres)){
      ...
      "--q-score-range ",temp.dir.prs,"q_range_file ",temp.dir.prs,"p_value_file header --threads 2 ",
      "--score-col-nums 3-4 ",
      "--score ",temp.dir.prs,"prs_file cols=+scoresums,-scoreavgs ",
      "--bfile ",temp.dir,"all_chr_test.mega --exclude ",old.out.dir,eth[i],"/duplicated.id  ",
      "--out ",temp.dir.prs,"prs_alleth_eb_rho_",l,"_size_",m,"_rep_",i_rep,"_GA_",i1,"_rind_",r_ind,"_wcind_",w_ind,"p_value_",k1))
