    ...
    for(l in 1:3){
      for(m in 1:4){
        ...
        for(i_rep in 1:n.rep){
          filename = paste0(out.dir,eth[i],"/r2.list_rho_allethebtest_",l,"_size_",m,"_rep_",i_rep,"_GA_",i1)
...
save(alleth.EB.result,file = paste0(out.dir,"LD.clump.result.allethtest.EB.rdata"))
