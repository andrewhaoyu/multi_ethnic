...
for(m in 1:4){
  ...
  write.table(prs.score,file = paste0(out.dir,eth[i],"/prs/prs_",j,"_pvalue_",k,"_rho_",l,"_size_",m,"_chr_",j,"_rep_",i_rep,"_GA_",i1,"_rind_",r_ind,"_wcind_",w_ind,".profile"),row.names = F,col.names = F,quote=F)
