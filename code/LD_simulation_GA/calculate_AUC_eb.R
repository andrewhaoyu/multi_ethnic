...
all.files <- dir(path=paste0(out.dir,eth[i],"/prs"),
    ...
    if(nrow(prs.all)>0){
      ...
      for(j in 1:22){
        ...
        if(length(idx)>0){
          ...
          filename <- paste0(out.dir,eth[i],"/prs/prs_eb_",k1,"_",k2,"_rho_",l,"_size_",m,"_chr_",j,"_rep_",i_rep,"_GA_",i1,".profile")
...
save(r2.list,file = paste0(out.dir,eth[i],"/r2.list_eb_rho_",l,"_size_",m,"_rep_",i_rep,"_GA_",i1))
