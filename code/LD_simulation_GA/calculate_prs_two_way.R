...
for(k1 in 1:length(pthres)){
  for(k2 in 1:length(pthres)){
    ...
    #for(j in 1:22){
    if(nrow(prs.file)>0){
      write.table(prs.file,file = paste0(temp.dir,"/prs_pvalue_two_way_",k1,"_",k2,"_rho_",l,"_size_",m,"_rep_",i_rep,"_GA_",i1),col.names = T,row.names = F,quote=F)
      res = system(paste0("/data/zhangh24/software/plink2 --threads 2 --score ",temp.dir,"prs_pvalue_two_way_",k1,"_",k2,"_rho_",l,"_size_",m,"_rep_",i_rep,"_GA_",i1," no-sum no-mean-imputation --bfile ",temp.dir,"chr",j,".tag --exclude ",out.dir,eth[i],"/duplicated.id  --out ",out.dir,eth[i],"/prs/prs_two_way_",k1,"_",k2,"_rho_",l,"_size_",m,"_chr_",j,"_rep_",i_rep,"_GA_",i1))
      if(res ==2){
        stop()
      }
      system(paste0("rm ",out.dir,"/prs/prs_pvalue_two_way_rho_",l,"_size_",m,"_",j,"_rep_",i_rep,"_GA_",i1,".nosex"))
      system(paste0("rm ",out.dir,"/prs/prs_pvalue_two_way_rho_",l,"_size_",m,"_",j,"_rep_",i_rep,"_GA_",i1,".log"))
      system(paste0("rm ",out.dir,"/prs/prs_pvalue_two_way_rho_",l,"_size_",m,"_",j,"_rep_",i_rep,"_GA_",i1,".nopred"))
      system(paste0("rm ",temp.dir,"/prs_pvalue_two_way_",k1,"_",k2,"_rho_",l,"_size_",m,"_rep_",i_rep,"_GA_",i1))
      gc()
