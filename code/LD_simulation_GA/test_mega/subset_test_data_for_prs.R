...
system(paste0("mv ",temp.dir,"/all_chr_test.tag.fam ",cur.dir,eth[i],"/"))
system(paste0("mv ",temp.dir,"/all_chr_test.tag.bim ",cur.dir,eth[i],"/"))
system(paste0("mv ",temp.dir,"/all_chr_test.tag.bed ",cur.dir,eth[i],"/"))
