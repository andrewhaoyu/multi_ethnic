...
res = system(paste0("/data/zhangh24/software/plink2 --threads 2 --bfile ",cur.dir,eth[i],"/all_chr.tag --keep ",temp.dir,"/ref_fam.fam  --out ",temp.dir,"/clump_1kgref_all_chr --make-bed"))
if(res==2){
  stop()
}
system(paste0("mv ",temp.dir,"/clump_1kgref_all_chr.fam ",cur.dir,eth[i],"/"))
system(paste0("mv ",temp.dir,"/clump_1kgref_all_chr.bim ",cur.dir,eth[i],"/"))
system(paste0("mv ",temp.dir,"/clump_1kgref_all_chr.bed ",cur.dir,eth[i],"/"))
