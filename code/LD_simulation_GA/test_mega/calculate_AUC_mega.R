...
for(m in 1:4){
  ...
  for(i_rep in 1:n.rep){
    LD <- as.data.frame(fread(paste0(cur.dir,eth[i],"/LD_clump_rho_",l,"_size_",m,"_rep_",i_rep,"_GA_",i1,"_",snplist,".clumped")))
      ...
      if(nrow(prs.all)>0){
        ...
        for(j in 1:22){
          ...
          if(length(idx)>0){
            ...
            filename <- paste0(cur.dir,eth[i],"/prs/prs_chr_",j,"_pvalue_",k,"_rho_",l,"_size_",m,"_chr_",j,"_rep_",i_rep,"_GA_",i1,"_",snplist,".profile")
    ...
    save(r2.list,file = paste0(cur.dir,eth[i],"/r2.list_rho_",l,"_size_",m,"_rep_",i_rep,"_GA_",i1,"_",snplist))
  }
}
