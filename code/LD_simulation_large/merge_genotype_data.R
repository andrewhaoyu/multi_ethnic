...
system(paste0("/data/zhangh24/software/plink2 --bfile /data/zhangh24/multi_ethnic/result/LD_simulation_new/",eth[i],"/chr",j,"_1.tag --merge-list /lscratch/",sid,"/test/",eth[i],"_all_files_chr_",j, " --make-bed --out /data/zhangh24/multi_ethnic/result/LD_simulation_new/",eth[i],"/chr",j,".tag"))
