...
#read the target ethnic group summary level statistics
  ...
  system(paste0("rm ",cur.dir,eth[i],"/prs/prs_eursnp_eb_rho_",l,"_size_",m,"_",j,"_rep_",i_rep,".log"))
  system(paste0("rm ",cur.dir,eth[i],"/prs/prs_eursnp_eb_rho_",l,"_size_",m,"_",j,"_rep_",i_rep,".nosex"))
  system(paste0("rm ",cur.dir,eth[i],"/prs/prs_eursnp_eb_rho_",l,"_size_",m,"_",j,"_rep_",i_rep,".nopred"))
  gc()
  }
}
