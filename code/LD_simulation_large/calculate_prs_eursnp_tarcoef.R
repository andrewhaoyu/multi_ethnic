...
system(paste0("/data/zhangh24/software/plink2 --score ",cur.dir,eth[i],"/prs/prs_eursnp_tarcoef_rho_",l,"_size_",m," no-sum no-mean-imputation --bfile ",cur.dir,eth[i],"/chr",j,".tag --exclude /data/zhangh24/multi_ethnic/result/LD_simulation/",eth[i],"/duplicated.id  --out ",cur.dir,eth[i],"/prs/prs_eursnp_tarcoef_rho_",l,"_size_",m))
