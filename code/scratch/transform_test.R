...
code <- rep("c",1000)
temp <- 1
/dcl01/chatterj/data/hzhang1/qctool_v2.0.1-Ubuntu16.04-x86_64/qctool -g /dcl01/chatterj/data/hzhang1/1000GP_Phase3/1000GP_Phase3_chr22.hap.gz -filetype impute_haplotypes -og /dcl01/chatterj/data/hzhang1/1000GP_Phase3/chr22 -ofiletype binary_ped


/data/zhangh24/software/qctool/qctool -g /data/zhangh24/KG.impute2/",eth[i],"/chr_all.hap -filetype impute_haplotypes -og /data/zhangh24/KG.plink/",eth[i],"/chr_all  -ofiletype binary_ped


zcat 1000GP_Phase3_chr10.hap.gz 1000GP_Phase3_chr11.hap.gz > chr_all.hap
