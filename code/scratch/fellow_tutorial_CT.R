...
#
bim = fread(paste0(temp.dir,eth,"all_chr.bim"))
fam = fread(paste0(temp.dir,eth,"all_chr.fam"))
...
res = system(paste0("/data/zhangh24/software/plink2 ",
                    ...
                    "--clump ",temp.dir,"all_chr_assoc.txt ",
                    "--clump-p1 ",pthr," ",
                    "--clump-r2 ",r2thr," " ,
                    "--clump-kb ",kbpthr," ",
                    "--out ",temp.dir,"LD_clump"))
...
#PRS = G*beta
prs_coeff = fread(paste0(temp.dir,"prs_coeff"))
prs_pvalue = fread(paste0(temp.dir,"p_value"))

res <- 
system(paste0("/data/zhangh24/software/plink2_alpha ",
"--q-score-range ",temp.dir,"q_range_file ",
temp.dir,"p_value header ",
"--score ",temp.dir,"prs_coeff ",
"cols=+scoresums,-scoreavgs header no-mean-imputation  ",
"--bfile ",temp.dir,"ukb/all_chr --out ",temp.dir,"prs"))
fam = fread(paste0(temp.dir,"ukb/all_chr.fam"))
...
#write down best prs in the prs folder
