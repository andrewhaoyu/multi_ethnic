...
png(filename = "../../presentation_plot/23andme_cvd.png",width=14,height = 9,units = "in",res = 300)
print(p)
dev.off()
...
#library(RColorBrewer)
png(filename = "../../presentation_plot/23andme_height.png",width=14,height = 9,units = "in",res = 300)
print(p)
dev.off()
