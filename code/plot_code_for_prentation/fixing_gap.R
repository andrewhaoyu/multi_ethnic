...
l = 1
  ...
  p <- ggplot(result.sub,aes(x= sample_size,y=relative.r2,group=eth.vec))+
    ...
    ggtitle(paste0("Relative performance of CT-SLEB over European PRS prediction"))+
  ...
  png(file = paste0("../../presentation_plot/fix_gap_summary_GA_fixed_common.png"),
...
png(file = paste0("../../presentation_plot/simple_fix_gap_all_snps.png"),
    width = 10, height = 7, res = 300,units = "in")
print(p)
dev.off()
