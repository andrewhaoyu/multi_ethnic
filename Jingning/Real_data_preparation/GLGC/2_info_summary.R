...
trait_all <- c("HDL","LDL","logTG","nonHDL","TC")
...
dat <- fread2(paste0("/dcs04/nilanjan/data/jzhang2/summary_data/GLGC_cleaned/",ethnic,"/",trait,".txt"))
res_t[i,1] <- max(dat$N)

num_rec <- readRDS(paste0("/dcs04/nilanjan/data/jzhang2/summary_data/GLGC_cleaned/",ethnic,"/",trait,"_NofSNP.rds"))
...
saveRDS(num_rec, paste0("/dcs04/nilanjan/data/jzhang2/summary_data/GLGC_cleaned/",ethnic,"/",trait,"_NofSNP.rds"))
...
write_tsv(res, "/dcs04/nilanjan/data/jzhang2/summary_data/GLGC_cleaned/info_summary.txt")
