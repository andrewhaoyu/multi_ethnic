...
#dir.create("/dcs04/nilanjan/data/jzhang2/UKBB/ancestry_prediction/ukbb_final/")
#dir.create("/dcs04/nilanjan/data/jzhang2/UKBB/ancestry_prediction/models/hdpca/ukbbPC_original")
#dir.create("/dcs04/nilanjan/data/jzhang2/UKBB/ancestry_prediction/predicted_ancestry")
#
#a <- paste0("/dcs04/nilanjan/data/jzhang2/TOOLS/plink/plink1/plink",
#            " --keep-allele-order",
...
#
#
#genos = read_plink(paste("/dcs04/nilanjan/data/jzhang2/UKBB/ancestry_prediction/ukbb_final/chrall"), impute="avg")
...
genos <- readRDS("/dcs04/nilanjan/data/jzhang2/UKBB/ancestry_prediction/models/hdpca/ukbbPC_original/std_geno.rds")
loadings <- readRDS( "/dcs04/nilanjan/data/jzhang2/UKBB/ancestry_prediction/models/pc1000G_20.loadings")
...
classifier_RF <- readRDS("/dcs04/nilanjan/data/jzhang2/UKBB/ancestry_prediction/models/rf_500.rds")
